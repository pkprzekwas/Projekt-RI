...
int Trig = 22;  //pin 2 Arduino połączony z pinem Trigger czujnika
int Echo = 23;  //pin 3 Arduino połączony z pinem Echo czujnika
...
void loop()
{
  ...
  {
    slave.buffer.analog[i] = 0;//analogRead(i);
  }
  ...
  slave.buffer.distance=distance;
